...
<head>
	...
	<script  type="text/javascript" src="../controller/js/clientesGUIController.js"></script>
...
<body>
	...
	<div class="jumbotron text-center">
		<h1>Clientes</h1>
		<p>Administre clientes y su información</p> 
	</div>
	<div class="container">
			...
			<div class="col-sm-12" id="crud-table">
				<div class="table-responsive">
					<table class="table">
						<thead>
							<tr class="blue-strip">
								<th id="tittle-cell">Administración de clientes</th>
								<th style="padding-bottom:1.5%;">Agregar cliente  <button type="button" class="btn btn-default btn-circle add-btn"><i class="glyphicon glyphicon-plus"></i></button></th>
								<th>
									<form class="navbar-form navbar-left" id="search-form">
										<div class="form-group">
											<input id="group_inp" type="text" class="form-control" placeholder="Buscar cliente"
							...
							<tr class="orange-strip">
								<th>Opciones</th><th>ID</th><th>Razon social</th>
							</tr>
						</thead>
